...
router.post('/deposit', (req, res) => {
  ...
  const result = TokenVault.deposit(contractAddress, fromAddress, Number(amount));
...
router.post('/withdraw', (req, res) => {
  ...
  const result = TokenVault.withdraw(contractAddress, toAddress, Number(amount), callerAddress);
